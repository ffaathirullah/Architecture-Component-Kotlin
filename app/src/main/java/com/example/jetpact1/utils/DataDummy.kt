package com.example.jetpact1.utils
...
object DataDummy {
    ...
    fun generateDummyModules(movieId: String): List<ModuleEntity> {
        ...
        modules.add(ModuleEntity(
            ...
            0))
        modules.add(ModuleEntity("{$movieId}m2",
            movieId,
            "Modul 1 : Teori 1",
            1, false))
        modules.add(ModuleEntity("{$movieId}m3",
            movieId,
            "Latihan 1",
            2, false))
        modules.add(ModuleEntity("{$movieId}m4",
            movieId,
            "Bedah Kode 1",
            3, false))
        modules.add(ModuleEntity("{$movieId}m5",
            movieId,
            "Modul 2 : Teori 2",
            4, false))

        modules.add(ModuleEntity("{$movieId}m6",
            movieId,
            "Latihan 2",
            5, false))

        modules.add(ModuleEntity("{$movieId}m7",
            movieId,
            "Bedah Kode 2",
            6, false))
